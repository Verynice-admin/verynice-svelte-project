...
const titlesToRemove = [
    ...
    "Aktau City Beach",
    "Aktau Embankment",
    "Aktau Seaside Promenade",
    "Caspian Sea Beaches",
    "Dostyk Park Aktau",
    "I Love Aktau Sign",
    "Kenderli Beach Resort",
    "Mangyshlak Peninsula",
    "Mangystau Regional Museum",
    "Mig Fighter Monument",
    "Rocky Path Underground Mosques",
    "Tupkaragan Peninsula",
    "Tuzbair Salt Flats",
    "Warm Beach Hot Springs",
    "Zhygylgan Fault"
];
...
async function runCleanup() {
    console.log('🚀 Starting Mangystau & Aktau Cleanup...');
    ...
    try {
        ...
        console.log(`\n✅ CLEANUP COMPLETE! Total Mangystau/Aktau attractions removed: ${totalDeleted}`);
