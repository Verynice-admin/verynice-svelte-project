...
const titlesToRemove = [
    "Friday Mosque Turkistan",
    "Karavan Saray Center",
    "Koshkar Ata River",
    "Retro Garage",
    "Sauran Ancient City",
    "Sayram Ancient City",
...
async function runCleanup() {
    ...
    try {
        ...
        console.log(`\n✅ CLEANUP COMPLETE! Total attractions removed: ${totalDeleted}`);
