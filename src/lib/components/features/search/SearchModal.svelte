<script lang="ts">
	...
	let loading = false;
	let aiResponse: { question: string; answer: string } | null = null;
	...
	const pages = [
		...
		{
			title: 'Attractions',
			description: 'Must-visit places: Almaty, Astana, Charyn Canyon.',
			url: '/attractions',
			keywords: 'tourism, sight, seeing, travel, places, nature'
		},
		{
			title: 'Tips',
