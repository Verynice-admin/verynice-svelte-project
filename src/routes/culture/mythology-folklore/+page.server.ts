...
export const load: PageServerLoad = async () => {
	...
	try {
		const pageRef = adminDB.collection('pages').doc('heritage').collection('articles').doc('mythology-folklore');
		...
		console.error('[culture/mythology-folklore] load error', error);
		return { page: FALLBACK_PAGE, sections: FALLBACK_SECTIONS };
	}
};
