		...
		<nav class="category-nav" aria-label="Jump to section">
			{#each sections as section (section.id)}
				<a href="#{section.id}" class="category-nav-link" on:click={(e) => scrollToSection(e, section.id)}>
					<span class="nav-icon">T</span><span class="nav-text">{section.title}</span>
				</a>
			{/each}
		</nav>
		{#each sections as section (section.id)}
				...
				<div class="dishes-list">
					<article class="dish-article">
						<div class="dish-article-image">
							...
							{:else}
								<div class="image-placeholder" role="img" aria-label={section.title}><span class="placeholder-text">{section.title}</span><span class="placeholder-icon">T</span></div>
							{/if}
						</div>
